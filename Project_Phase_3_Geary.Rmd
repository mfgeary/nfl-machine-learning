...
For all 5 models, I used cross-validation and tuning in order to maximize the performance of the models. The tuning parameters were chosen using a maximum entropy grid search. The best parameters were chosen based on the root mean square error.
